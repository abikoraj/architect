<section class="about section-margin mb-5">
    <div class="container">
        <div class="section-intro">
            <h4 class="section-intro__title">ABOUT</h4>
            <h2 class="section-intro__subtitle bottom-border">About Our Company</h2>
        </div>
        <div class="row align-items-center">
            ...
            <div class="col-md-7 pl-xl-5">
                ...
                <p>If you are looking at blank cassettes on the web lorem ipsum dolor sit amet, consectetur
                    ...
                    minim veniam. Eiusmod tempor incididunt ut labore et dolore magna aliqua consectetur adipisicing
